<a>
    <h1 align="center">
      NGX-DUALITY
      <i style="font-weight: lighter; font-size: 15px">for</i>
...
**Improve development speed with the components included on this library for Angular 6.**

<p align="center" style="padding: 20px; background: #FFF3F3; color: red; font-size: 14px;">WARNING: THE LATEST VERSION OF THE REPO IS NOT PUBLISHED YET ON NPM.</p>

## Table of contents 
1. [Run local](#local)
2. [Installation](#installation)
3. [Available Modules](#available-modules)
4. [Modules Description & Usage](#modules-description-usage)
...
To run the library on your local machine follow the next steps:

* Clone the project.
* Install node modules: `npm install`
* Build the ngx-duality library: `npm run build-lib`
* Run project: `ng serve`

If you followed all the steps the demo page will appear.

The library is on **projects/ngx-duality** folder, in order to apply changes on the library a **re-build** is required.

For more documentation about libraries refer to this [link](https://github.com/angular/angular-cli/wiki/stories-create-library).
...
```
Import `NgxModule` on `AppModule` to get access to all component of this library, or you can import the specific module that you need for your project.
(PD: See [modules description](#modules-description-usage) for more details.)
...
Next add the follow css file into your app, if you'r project it's using angular-cli go to ".angular-cli" file and add the following path in the styles parameter
...
```
Also you can add it into your main style file (styles.css)
...
Once you install Duality go to the `AppModule` of your project and import `NgxOverStyleModule` (if you already imported `NgxDualityModule` skip this step):
...
import { NgxOverStyleModule } from 'ngx-duality';
...
The instructions of this document are for the [npm version](https://www.npmjs.com/package/ngx-duality) of the library and will change once the npm library gets updated with the repo.